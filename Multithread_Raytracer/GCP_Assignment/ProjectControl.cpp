...
//	int windowWidth, windowHeight;	// Width and height of screen int
//	unsigned int _lastTime;				// Last time for fps
//
//}
//
//
//bool GCP::sdlSetUp(int windowWidth, int windowHeight)
//{
...
//	}
//
//	windowWidth = windowWidth;			// Window width set
//	windowHeight = windowHeight;		// Window height set
//
//	int windowPosX = 100; // Window X position
//	int windowPosY = 100; // Window Y position
//
//	_window = SDL_CreateWindow("GCP", windowPosX, windowPosY, WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
...
//	}
//
//	GCP::_renderer = SDL_CreateRenderer(_window, -1, 0);		// Create a renderer for the screen
//
//
...
//}
//
//void GCP::setBackground(int red, int green, int blue)
//{
...
//}
//
//void GCP::drawPixel(int pixelX, int pixelY, int red, int green, int blue)
//{
//
//	SDL_SetRenderDrawColor(_renderer, red, green, blue, 255);  // Set the colour for drawing
...
//}
//
//void GCP::cleanUp()  // Clean up used to end the program
//{
//
...
//
//
//int GCP::showAndHold()			// Show and hold presents and holds the screen
//{
//
